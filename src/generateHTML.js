...
const manager = managerData => {
  ...
  // Iterate through array, creates cards for employees, and combine all cards together
  ...
  const HTML_page = data => {
    ...
    <html>
      <head>
        ...
        <link rel="stylesheet" href="./style.css"><source src="../generateHTML.js" type="page-template">
      </head>
      <body>
